    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-red-900 flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-6 sm:space-y-8 relative z-10">
        <div className="text-center animate-fade-in">
          <div className="mx-auto w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-red-600 to-red-700 rounded-full flex items-center justify-center mb-4 sm:mb-6 shadow-2xl animate-pulse">
            <span className="text-white font-bold text-xl sm:text-2xl">C</span>
          </div>
          <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-red-500 to-yellow-400 bg-clip-text text-transparent mb-2">
            Churrasquinho & Cia
          </h1>
          <p className="text-gray-300 text-base sm:text-lg">O melhor churrasquinho da região!</p>
        </div>

        <Card className="bg-gray-900/90 backdrop-blur-sm border-gray-700 shadow-2xl animate-scale-in">
          <CardHeader className="text-center px-4 sm:px-6">
            <CardTitle className="text-xl sm:text-2xl text-white">Login de Clientes</CardTitle>
