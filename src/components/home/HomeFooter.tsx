    ...
    <footer className="bg-black text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          ...
          {/* Coluna 2: Links */}
          <div className="animate-scroll-reveal" style={{ animationDelay: '200ms' }}>
          ...
          {/* Coluna 3: Contato */}
          <div className="animate-scroll-reveal" style={{ animationDelay: '400ms' }}>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center animate-scroll-reveal" style={{ animationDelay: '600ms' }}>
