  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">R$ {stats.dailyRevenue.toFixed(2)}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-xs text-muted-foreground grid grid-cols-2 gap-1">
            <div>Pix: <span className="font-bold">{stats.paymentMethods.pix}</span></div>
            <div>Cartão: <span className="font-bold">{stats.paymentMethods.cartao}</span></div>
            <div>Dinheiro: <span className="font-bold">{stats.paymentMethods.dinheiro}</span></div>
          </div>
        </CardContent>
      </Card>
    </div>
